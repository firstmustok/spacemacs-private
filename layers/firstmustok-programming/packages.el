...
(defun firstmustok-programming/post-init-robe ()
  (progn
    (add-hook 'inf-ruby-mode-hook 'spacemacs/toggle-auto-completion-on)
    (defun firstmustok/ruby-send-current-line (&optional print)
    ...
    (defun firstmustok/ruby-send-current-line-and-go ()
      (interactive)
      (firstmustok/ruby-send-current-line)
      (ruby-switch-to-inf t))

    (defun firstmustok/start-inf-ruby-and-robe ()
      (interactive)
    ...
    (dolist (mode '(ruby-mode enh-ruby-mode))
      (spacemacs/set-leader-keys-for-major-mode mode
        "sb" 'ruby-send-block
        "sB" 'ruby-send-buffer
        "sl" 'firstmustok/ruby-send-current-line
        "sL" 'firstmustok/ruby-send-current-line-and-go
        "sI" 'firstmustok/start-inf-ruby-and-robe))))

(defun firstmustok-programming/init-editorconfig ()
  (use-package editorconfig
    :init
    (progn
      (defun conditional-enable-editorconfig ()
        (if (and (firstmustok/git-project-root)
                 (locate-dominating-file default-directory ".editorconfig"))
            (editorconfig-apply)))
      (add-hook 'prog-mode-hook 'conditional-enable-editorconfig))))

(defun firstmustok-programming/post-init-cider ()
  (setq cider-cljs-lein-repl
        "(do (require 'figwheel-sidecar.repl-api)
           (figwheel-sidecar.repl-api/start-figwheel!)
           (figwheel-sidecar.repl-api/cljs-repl))")

  (defun firstmustok/cider-figwheel-repl ()
    (interactive)
    (save-some-buffers)
  ...
  (global-set-key (kbd "C-c C-f") #'firstmustok/cider-figwheel-repl))

(defun firstmustok-programming/post-init-graphviz-dot-mode ()
  (with-eval-after-load 'graphviz-dot-mode
      (require 'company-keywords)
      (push '(graphviz-dot-mode  "digraph" "node" "shape" "subgraph" "label" "edge" "bgcolor" "style" "record") company-keywords-alist)))

(defun firstmustok-programming/post-init-dumb-jump ()
...
(defun firstmustok-programming/post-init-clojure-mode ()
  )

(defun firstmustok-programming/post-init-emacs-lisp ()
    (remove-hook 'emacs-lisp-mode-hook 'auto-compile-mode))

(defun firstmustok-programming/post-init-python ()
  (add-hook 'python-mode-hook #'(lambda () (modify-syntax-entry ?_ "w")))
  ;; if you use pyton3, then you could comment the following line
  (setq python-shell-interpreter "python"))

(defun firstmustok-programming/post-init-js-doc ()
  (setq js-doc-mail-address "linux.whu@gmail.com"
        js-doc-author (format "Wallace Young <%s>" js-doc-mail-address)
        js-doc-url "http://www.firstmustok.com"
        js-doc-license "MIT")

  )


(defun firstmustok-programming/init-ctags-update ()
...
;; (defun firstmustok-programming/init-js-comint ()
...
(defun firstmustok-programming/post-init-web-mode ()
...
(defun firstmustok-programming/post-init-yasnippet ()
  (progn
    ...
    (spacemacs/add-to-hooks 'firstmustok/load-yasnippet '(prog-mode-hook
                                                            markdown-mode-hook
                                                            org-mode-hook))
    ))

(defun firstmustok-programming/post-init-racket-mode ()
  (progn
...
(defun firstmustok-programming/post-init-json-mode ()
...
(defun firstmustok-programming/init-nodejs-repl ()
  (use-package nodejs-repl
    :init
    :defer t))

(defun firstmustok-programming/init-flycheck-package ()
  (use-package flycheck-package))

(defun firstmustok-programming/init-lispy ()
  (use-package lispy
    :defer t
    :init
    (progn
...
(defun firstmustok-programming/init-cmake-font-lock ()
  (use-package cmake-font-lock
    :defer t))

(defun firstmustok-programming/init-google-c-style ()
  (use-package google-c-style
    :init (add-hook 'c-mode-common-hook 'google-set-c-style)))

(defun firstmustok-programming/post-init-cmake-mode ()
  (progn
...
(defun firstmustok-programming/post-init-flycheck ()
...
(defun firstmustok-programming/post-init-eldoc ()
  (setq eldoc-idle-delay 0.4))


(defun firstmustok-programming/post-init-js2-refactor ()
  (progn
    (spacemacs/set-leader-keys-for-major-mode 'js2-mode
      "r>" 'js2r-forward-slurp
      "r<" 'js2r-forward-barf)))

(defun firstmustok-programming/post-init-js2-mode ()
  (progn
    ...
    (firstmustok|toggle-company-backends company-tern)
...
(defun firstmustok-programming/post-init-css-mode ()
  (progn
...
(defun firstmustok-programming/post-init-tagedit ()
  (add-hook 'web-mode-hook (lambda () (tagedit-mode 1))))

;; For each extension, define a function firstmustok/init-<extension-name>
;;
(defun firstmustok-programming/init-doxymacs ()
  "Initialize doxymacs"
...
(defun firstmustok-programming/init-nodejs-repl-eval ()
...
(defun firstmustok-programming/post-init-lua-mode ()
  (progn
...
(defun firstmustok-programming/post-init-cc-mode ()
  (progn
...
(defun firstmustok-programming/init-flycheck-clojure ()
  (use-package flycheck-clojure
    :defer t
    :init
    (eval-after-load 'flycheck '(flycheck-clojure-setup))))

(defun firstmustok-programming/post-init-ycmd ()
  (progn
    ...
    (firstmustok|toggle-company-backends company-ycmd)
...
(defun firstmustok-programming/init-etags-select ()
...
(defun firstmustok-programming/init-paredit ()
  (use-package paredit
...
(defun firstmustok-programming/post-init-company ()
  (progn
