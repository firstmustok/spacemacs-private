...
(defun firstmustok-misc/init-browse-at-remote ()
  (use-package browse-at-remote
    :defer t
    :init (spacemacs/set-leader-keys "gho" 'browse-at-remote)))

(defun firstmustok-misc/init-highlight-global ()
...
(defun firstmustok-misc/post-init-golden-ratio ()
...
(defun firstmustok-misc/post-init-ranger ()
...
(defun firstmustok-misc/init-helm-ag ()
  (use-package helm-ag
    :defer t
    :init
    (progn
...
(defun firstmustok-misc/post-init-gist ()
  (use-package gist
    :defer t
    :init
...
(defun firstmustok-misc/init-peep-dired ()
...
(defun firstmustok-misc/post-init-flyspell-correct ()
  (progn
    (with-eval-after-load 'flyspell
      (define-key flyspell-mode-map (kbd "C-;") 'flyspell-correct-previous-word-generic))
    (setq flyspell-correct-interface 'flyspell-correct-ivy)))

(defun firstmustok-misc/post-init-smartparens ()
...
(defun firstmustok-misc/init-tiny ()
  (use-package tiny
    :defer t
    :init
    (spacemacs/set-leader-keys "oe" 'tiny-expand)))

(defun firstmustok-misc/post-init-helm ()
...
(defun firstmustok-misc/init-helm-github-stars ()
  (use-package helm-github-stars
    :commands (helm-github-stars)
    :init
    (setq helm-github-stars-username "firstmustok")))




(defun firstmustok-misc/post-init-fcitx ()
  (fcitx-aggressive-setup))

(defun firstmustok-misc/post-init-command-log ()
...
(defun firstmustok-misc/init-litable ()
  (use-package litable
    :init
    :defer t))

(defun firstmustok-misc/init-osx-dictionary ()
...
(defun firstmustok-misc/init-4clojure ()
...
(defun firstmustok-misc/post-init-avy ()
  (progn
    (global-set-key (kbd "C-s-'") 'avy-goto-char-2)
    (global-set-key (kbd "M-'") 'avy-goto-char-2)))

(defun firstmustok-misc/post-init-ace-window ()
  (global-set-key (kbd "C-x C-o") #'ace-window))

(defun firstmustok-misc/init-discover-my-major ()
...
(defun firstmustok-misc/post-init-elfeed ()
  (use-package elfeed
    :init
    ...
    (progn
      ...
      (defun firstmustok/elfeed-mark-all-as-read ()
        (interactive)
        (mark-whole-buffer)
        (elfeed-search-untag-all-unread))

      (define-key elfeed-search-mode-map (kbd "R") 'firstmustok/elfeed-mark-all-as-read)
...
(defun firstmustok-misc/post-init-evil ()
  (progn
    ...
    (define-key evil-normal-state-map
      (kbd "Y") 'firstmustok/yank-to-end-of-line)
    ...
    (define-key evil-visual-state-map (kbd "C-r") 'firstmustok/evil-quick-replace)
    ...
    ;; (defadvice evil-insert-state (around firstmustok/holy-mode activate)
...
(defun firstmustok-misc/init-visual-regexp ()
  (use-package visual-regexp
    :commands (vr/replace vr/query-replace)))

(defun firstmustok-misc/init-visual-regexp-steroids ()
...
(defun firstmustok-misc/init-multiple-cursors ()
...
;;; Occasionally useful
    ...
    (setq mc/cmds-to-run-once
          '(
            counsel-M-x
            firstmustok/my-mc-mark-next-like-this))
...
(defun firstmustok-misc/post-init-persp-mode ()
...
(defun firstmustok-misc/post-init-chinese-wbim ()
  (progn
...
(defun firstmustok-misc/post-init-evil-escape ()
  (setq evil-escape-delay 0.2))

(defun firstmustok-misc/init-find-file-in-project ()
...
(defun firstmustok-misc/post-init-projectile ()
  (progn
  ...
  current project. Otherwise do `occur' in the current file."
    ...
    (spacemacs/set-leader-keys "pf" 'firstmustok/open-file-with-projectile-or-counsel-git)
    (spacemacs/set-leader-keys "pt" 'my-simple-todo)))

(defun firstmustok-misc/init-moz-controller ()
...
(defun firstmustok-misc/init-ag ()
  (use-package ag
    :init))

(defun firstmustok-misc/post-init-erc ()
  (progn
    (add-hook 'erc-text-matched-hook 'my-erc-hook)
    (spaceline-toggle-erc-track-off)))

(defun firstmustok-misc/init-wrap-region ()
...
(defun firstmustok-misc/init-keyfreq ()
  (use-package keyfreq
    :init
    (progn
      (keyfreq-mode t)
...
(defun firstmustok-misc/post-init-swiper ()
...
(defun firstmustok-misc/post-init-magit ()
  (progn
    ...
    (eval-after-load 'magit
      '(define-key magit-mode-map (kbd "C-c g")
         #'firstmustok/magit-visit-pull-request))

    (setq magit-process-popup-time 10)))

(defun firstmustok-misc/post-init-git-messenger ()
  (use-package git-messenger
    :defer t
    :config
    (progn
      (define-key git-messenger-map (kbd "f") 'firstmustok/github-browse-commit))))

(defun firstmustok-misc/post-init-markdown-mode ()
  (progn
    ...
    (with-eval-after-load 'markdown-mode
      (progn
        ...
        (spacemacs/set-leader-keys-for-major-mode 'gfm-mode-map
          "p" 'firstmustok/markdown-to-html)
