;;; keybindings.el --- firstmustok Layer packages File for Spacemacs
;;
...
(define-key global-map (kbd "<f8>") 'firstmustok/show-current-buffer-major-mode)
...
(global-set-key (kbd "s-d") 'firstmustok/my-mc-mark-next-like-this)
(bind-key* "s-r" 'mc/reverse-regions)
(global-set-key (kbd "<f5>") 'firstmustok/run-current-file)
...
(when (spacemacs/system-is-mac)
 (spacemacs/set-leader-keys "o!" 'firstmustok/iterm-shell-command))
...
;; (bind-key* "s-r" 'firstmustok/browser-refresh--chrome-applescript)
(bind-key* "s-;" 'firstmustok/insert-semicolon-at-the-end-of-this-line)
(bind-key* "C-s-;" 'firstmustok/delete-semicolon-at-the-end-of-this-line)
(bind-key* "s-," 'firstmustok/insert-comma-at-the-end-of-this-line)
;; (bind-key* "C-s-," 'firstmustok/delete-comma-at-the-end-of-this-line)
(bind-key* "C-c l" 'firstmustok/insert-chrome-current-tab-url)
;; (bind-key* "M-s o" 'occur-dwim)
(bind-key* "C-=" 'er/expand-region)
(bind-key* "M--" 'firstmustok/goto-match-paren)
...
(global-set-key (kbd "<f1>") 'firstmustok/helm-hotspots)
(spacemacs/set-leader-keys "oo" 'firstmustok/helm-hotspots)

(spacemacs/set-leader-keys "oc" 'my-auto-update-tags-when-save)
;; (spacemacs/set-leader-keys "op" 'firstmustok/org-save-and-export)
(spacemacs/set-leader-keys "fR" 'firstmustok/rename-file-and-buffer)
...
(spacemacs/set-leader-keys "or" 'firstmustok/browser-refresh--chrome-applescript)
...
(spacemacs/set-leader-keys "sj" 'firstmustok/counsel-imenu)
;; deal with BOM
...
(spacemacs/set-leader-keys "oll" 'firstmustok/load-my-layout)
(spacemacs/set-leader-keys "ols" 'firstmustok/save-my-layout)
...
(spacemacs/set-leader-keys "os" 'firstmustok/search-in-fireball)
